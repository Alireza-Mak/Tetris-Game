...
void TestSuite3::runTestSuite3()
{
	std::cout << "=== Running TestSuite3 =========================" << "\n";
	...
	std::cout << "=== TestSuite3 complete ========================" << "\n\n";
}

void TestSuite3::announceTest(const std::string& className) {
	std::cout << "Testing " << className << " class...";
}

void TestSuite3::announceTestCompletion() {
	std::cout << "passed!\n\n";
}

void TestSuite3::announceNotTested(const std::string& className)
{
	...
	std::cout << " in TestSuite3.h to test)\n\n";
}
...
void TestSuite3::testPointClass()
{
#ifdef POINT
	announceTest("Point");
...
void TestSuite3::testTetrominoClass()
{
#ifdef TETROMINO
...
void TestSuite3::testGameboardClass()
{
#ifdef GAMEBOARD
 ...
 void TestSuite3::testGridTetrominoClass()
{
#ifdef GRIDTETROMINO
